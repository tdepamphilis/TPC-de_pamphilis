        ...
        <div class="container">
            ...
            <div class="row justify-content-center">
                <div class="col4 justify-content-center">
                    <asp:Button ID="Buttonprev" runat="server" Text="anterior"  Class="btn btn-secondary mx-1" OnClick="Buttonprev_Click" />
                    <asp:Button ID="Buttonnext" runat="server" Text="siguiente" Class="btn btn-secondary mx-1 " OnClick="Buttonnext_Click" />
                </div>
